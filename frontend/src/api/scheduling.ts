import type { ScheduleAssignment, ScheduleCandidate, ScheduleCreateInput, ScheduleDetail, ScheduleSummary } from '../types/scheduling'
...
export function getScheduleCandidates(id: number) {
  return requestJson<ScheduleCandidate[]>(`/api/scheduling/schedules/${id}/eligible-members/`, {}, 'Nao foi possivel carregar os candidatos.')
}
